"""
ГЕНЕРАТОР СИНТЕТИЧЕСКИХ ДАННЫХ JIRA ДЛЯ A/B-ТЕСТА
Санкт-Петербургский политехнический университет Петра Великого

Этот скрипт создает реалистичный, но полностью вымышленный датасет,
имитирующий экспорт из JIRA. Используется для демонстрации методологии
A/B-тестирования без раскрытия реальных корпоративных данных.
"""
